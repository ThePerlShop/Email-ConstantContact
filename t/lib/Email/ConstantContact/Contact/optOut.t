...
t::lib::Email::ConstantContact::Contact::optOut->runtests;


BEGIN {
package t::lib::Email::ConstantContact::Contact::optOut;
use strict;
use warnings;
...
t::lib::Email::ConstantContact::Contact::optOut - Unit test the C<< Email::ConstantContact::Contact->optOut() >> method.

=head1 SYNOPSIS

    # run all tests  
    prove -lv t/lib/Email/ConstantContact/Contact/optOut.t

    # run single test method
    TEST_METHOD=test_METHOD_NAME prove -lv t/lib/Email/ConstantContact/Contact/optOut.t
...
sub test_smoke : Test(3) {
    ...
    ok( $contact->optOut(), 'optOut() success' );
